...
export class ServiceProvidersFilterDto extends BaseFilterDto {
  @Transform(({ value }) => CastHelper.trim(value))
  @IsOptional()
  @IsEmail()
  email?: string;
...
export class ServiceProviderPreviewDto extends BaseDto {
  @Expose()
  email: string;
...
export class ServiceProviderDto extends ServiceProviderPreviewDto {
  @Expose()
  accountType: PaymentMethodCode;
