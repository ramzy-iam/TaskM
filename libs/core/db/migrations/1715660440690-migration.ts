...
export class Migration1715660440690 implements MigrationInterface {
    name = 'Migration1715660440690'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "dev"."Users" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "email" character varying NOT NULL, "password" character varying NOT NULL, "firstName" character varying, "lastName" character varying, CONSTRAINT "PK_16d4f7d636df336db11d87413e3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "dev"."Workspaces" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "name" character varying NOT NULL, "code" character varying NOT NULL, "userId" integer NOT NULL, CONSTRAINT "UQ_32b6b71c90ef76f7737345f49e5" UNIQUE ("code"), CONSTRAINT "PK_35160e1c18ee262230a1848e5fd" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "dev"."WorkspaceUsers" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "workspaceId" integer NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_94f6f5026059fab49269d3648fb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "dev"."Workspaces" ADD CONSTRAINT "FK_53267561ee2d1713890d2d735e6" FOREIGN KEY ("userId") REFERENCES "dev"."Users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "dev"."Workspaces" DROP CONSTRAINT "FK_53267561ee2d1713890d2d735e6"`);
