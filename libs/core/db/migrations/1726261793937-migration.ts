...
export class Migration1726261793937 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "taskm"."Tasks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "serviceproviderId" uuid NOT NULL, "projectId" uuid NOT NULL, "rateId" uuid NOT NULL, "code" character varying NOT NULL, "status" "taskm"."Tasks_status_enum" NOT NULL DEFAULT 'NOT_STARTED', "type" "taskm"."Tasks_type_enum" NOT NULL, "unit" "taskm"."Tasks_unit_enum" NOT NULL, "lang" "taskm"."Tasks_lang_enum" NOT NULL, "count" numeric(20,6) NOT NULL, "assignedAt" TIMESTAMP WITH TIME ZONE NOT NULL, "deliveredAt" TIMESTAMP WITH TIME ZONE, "deadline" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "UQ_fef49a104df9857a8edfec2ee38" UNIQUE ("code"), CONSTRAINT "PK_f38c2a61ff630a16afca4dac442" PRIMARY KEY ("id"))`);
